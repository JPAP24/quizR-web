...
const App = () => {
  ...
  const handleLogout = () => {
    ...
    // Use the callback of setToken to ensure that it has completed before navigating
    setToken((prevToken) => {
      if (!prevToken) {
        navigate("/");
      }
    ...
    <Layout>
      ...
      <Layout className="bg-default">
        ...
        >
          ...
          />
          <Button type="primary" shape="circle" icon={<LogoutOutlined />} size={size} onClick={handleLogout}></Button>
        </Header>
        <Content
          style={{
            margin: "24px 16px",
          ...
          <Row gutter={16}>
            <Col span={12} className="gutter-row">
              ...
              >
                ...
                <p className="mb-12">Here are some of the updates on your portal.</p>
